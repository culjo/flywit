...
//import 'package:flutter/scaffold.dart';
...
class BottomSheet extends StatefulWidget {
  ...
  const BottomSheet({
    ...
    this.enableDrag = false, // Boss Level
...
class _ModalBottomSheetLayout extends SingleChildLayoutDelegate {
  ...
  BoxConstraints getConstraintsForChild(BoxConstraints constraints) {
    return new BoxConstraints(
        ...
        minHeight: 0.0,
//        maxHeight: constraints.maxHeight * 9.0 / 16.0 // Boss Level 3
...
class _ModalBottomSheetRoute<T> extends PopupRoute<T> {
  ...
  @override
  bool get barrierDismissible => false; // Boss Level 1
...
Future<T> showBossModalBottomSheet<T>({
  ...
  return Navigator.push(context, new _ModalBottomSheetRoute<T>(
    builder: builder,
    theme: Theme.of(context).copyWith(canvasColor: color ?? Colors.white), // Colors.transparent),
